 ...
 * container to identify one method as <code>validate method</code>. A
 * <code>validate method</code> is a method that is designated to be
 * automatically invoked by JGentle container when corresponding
 * {@link PoolScope pool_scoped bean} is destroyed.
 * 
