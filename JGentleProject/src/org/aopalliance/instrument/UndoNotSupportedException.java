...
/**
 * The exception that is raised when the client program tries to undo an
 * instrumentation and when current implementation does not support it.
 * <p>
 * Undoing is implemented by the {@link Instrumentor#undo(Instrumentation)}
 * method.
 * 
 * @see Instrumentor
 */
