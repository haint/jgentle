...
/**
 * Represents the {@link ParameterFilter} pointcut.
 * 
 ...
 */
public interface PointcutOfParameterFilter<T extends Matching> extends
		Pointcut<T> {
	/**
	 * Returns the {@link ParameterFilter} for this pointcut
	 * 
	 * @return the {@link ParameterFilter} (never <code>null</code>)
	 */
