...
/**
 * Represents the {@link MethodFilter} pointcut.
 * 
 ...
 */
public interface PointcutOfMethodFilter<T extends Matching> extends Pointcut<T> {
	/**
	 * Returns the {@link MethodFilter} for this pointcut
	 * 
	 * @return the {@link MethodFilter} (never <code>null</code>)
	 */
