...
/**
 * Represents the {@link ClassFilter} pointcut.
 * 
 ...
 * @see PointcutOfAll
 */
public interface PointcutOfClassFilter<T extends Matching> extends Pointcut<T> {
	/**
	 * Return the {@link ClassFilter} for this pointcut.
	 * 
	 * @return the {@link ClassFilter} (never <code>null</code>)
	 */
