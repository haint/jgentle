 ...
 * {@link Matcher#matches(Object)} of specified {@link Matcher}. Also, It is an
 * extension of {@link MetadataControl}s so it can store any
 * {@link MetadataControl} in it to provide additional information for
 * {@link Matcher} implementation to perform.
 * 
 ...
 * @see MetadataControl
 */
public interface Matching extends MetadataControl {
	/**
