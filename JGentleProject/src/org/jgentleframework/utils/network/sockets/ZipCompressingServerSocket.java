 ...
 * {@link ZipCompressingSocket}. A server socket waits for requests to come in
 ...
 * @date Feb 13, 2009
 */
public class ZipCompressingServerSocket extends ServerSocket {
	/**
	 ...
	 */
	public ZipCompressingServerSocket(int port) throws IOException {
	...
	public Socket accept() throws IOException {
		...
		Socket returnValue = (Socket) new ZipCompressingSocket();
