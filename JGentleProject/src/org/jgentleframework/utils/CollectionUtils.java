...
public abstract class CollectionUtils {
	 ...
	 */
	public static <T> T findFirstMatch(Collection<T> source,
			Collection<T> candidates) {
	...
	public static <T> T findValueOfType(
			Collection<? extends Object> collection, Class<T> type) {
	...
	public static Object findValueOfType(
			Collection<? extends Object> collection, Class<?>[] types) {
