...
public class CompressionOutputStream extends FilterOutputStream implements
	...
	public void write(byte b[], int off, int len) throws IOException {
		...
		/*
		 * This implementation is quite inefficient because it has to call the
		 * other write method for every byte in the array. It could be optimized
		 * for performance by doing all the processing in this method.
		 */
		for (int i = 0; i < len; i++)
			write(b[off + i]);
	}
