...
/**
 * The Class CompressionInputStream.
 * 
 * @author Quoc Chung - mailto: <a
 *         href="mailto:skydunkpro@yahoo.com">skydunkpro@yahoo.com</a>
 * @date Feb 19, 2009
 */
public class CompressionInputStream extends FilterInputStream implements
		CompressionConstants {
	/**
	 * Instantiates a new compression input stream.
	 * 
	 * @param in
	 *            the in
	 */
	...
	/*
	 * This method reads up to len bytes from the input stream. Returns if read
	 * blocks before len bytes are read. (non-Javadoc)
	...
	/**
	 * If there is no more data to decode left in buf, read the next four bytes
	 * from the wire. Then store each group of 6 bits in an element of buf.
	 * Return one element of buf.
	 * 
	 * @return the int
	 * @throws IOException
