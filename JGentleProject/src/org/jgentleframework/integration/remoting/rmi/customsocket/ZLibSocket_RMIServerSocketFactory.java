...
/**
 * The Class ZLibSocket_RMIServerSocketFactory.
 * 
 ...
 */
public class ZLibSocket_RMIServerSocketFactory implements
	...
	public ServerSocket createServerSocket(int port) {
		...
		try {
			return new ZLibCompressingServerSocket(port);
		}
		catch (IOException e) {
			if (log.isFatalEnabled()) {
				log.fatal("Could not create ZLib Compressing Server Socket !",
						e);
			}
		}
		return null;
	...
	public boolean equals(Object object) {
		...
		return object instanceof ZLibSocket_RMIServerSocketFactory;
	}
