...
/**
 * All classed implement this interface must be abstract classes, calling
 * <code>configurable classes</code>. The <code>configurable class</code> must
 * override {@link #configure()} method in order to specify config information
 * and also must not implement other abstract methods. All abstract methods
 * except {@link #configure()} will be generated by JGentle system when
